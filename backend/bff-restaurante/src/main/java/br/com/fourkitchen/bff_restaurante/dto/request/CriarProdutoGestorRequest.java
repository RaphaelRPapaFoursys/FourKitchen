...
@Schema(description = "Dados enviados pelo gestor/admin para cadastrar um produto.")
public record CriarProdutoGestorRequest(
        @Schema(description = "Nome unico de exibicao do produto", example = "Risoto de cogumelos", minLength = 3, maxLength = 150)
