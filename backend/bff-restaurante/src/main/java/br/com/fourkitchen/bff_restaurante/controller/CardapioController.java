...
public class CardapioController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            array = @ArraySchema(schema = @Schema(implementation = CategoriaCardapioResponse.class)),
                            examples = @ExampleObject(value = "[{\"categoriaId\":1,\"categoriaNome\":\"Lanches\",\"categoriaDescricao\":\"Sanduiches, porcoes e combinados\",\"categoriaImagem\":\"iVBORw0KGgoAAAANSUhEUgAA...\",\"produtos\":[{\"id\":10,\"nome\":\"X-Burger\",\"descricao\":\"Pao, carne, queijo e molho da casa\",\"imagem\":null,\"preco\":29.90}]}]")
                    )
            ),
            @ApiResponse(responseCode = "401", description = "Token ausente, invalido ou expirado", content = @Content(schema = @Schema(implementation = ErrorObject.class))),
